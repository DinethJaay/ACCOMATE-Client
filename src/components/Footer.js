          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm leading-6">
                    Accomate makes it easy for students and workers to find nearby boarding accommodations with comfort and convenience. Your satisfaction is our mission.
                  </p>
                </div>
              </div>
            </div>
            <div className="flex flex-col items-center">
              ...
              <ul className="space-y-3">
                ...
                <li><a href="" className="hover:text-blue-300">Boardings</a></li>
                <li><a href="" className="hover:text-blue-300">Contact</a></li>
              </ul>
            </div>
            <div className="flex flex-col items-center md:items-start">
              <h3 className="text-xl font-semibold mb-3">Contact Us</h3>
              <p className="mb-2">Email: <a href="mailto:info@bodoapp.com" className="hover:underline">info@accomate.com</a></p>
